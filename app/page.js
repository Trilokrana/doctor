    ...
    <div className={`text-center text-xl m-4 ${styles.container}`}>
      ...
      <div className={`flex flex-col md:flex-row justify-around border-2 m-10 p-6 rounded-lg ${styles.cardContainer}`}>
        <div className={`border-2 p-6 m-4 rounded-lg hover:bg-gray-100 transition duration-500 ${styles.card}`}>
          <Link href="/Dentist">
            <Image className='rounded-lg' src={'https://t3.ftcdn.net/jpg/01/97/37/30/360_F_197373009_Mr2yNi8zxaYCpiIiP9gOB8QNDKqUpWo2.jpg'} width={300} height={300} />
        ...
        <div className={`border-2 p-6 m-4 rounded-lg hover:bg-gray-100 transition duration-500 ${styles.card}`}>
          <Link href="Orthopedics">
            <Image className='rounded-lg' src={'https://wp02-media.cdn.ihealthspot.com/wp-content/uploads/sites/476/2020/05/iStock-994645346-1024x683.jpg'} width={300} height={300} />
        ...
        <div className={`border-2 p-6 m-4 rounded-lg hover:bg-gray-100 transition duration-500 ${styles.card}`}>
          <Link href="Gyanocologist">
            <Image className='rounded-lg' src={'https://thumbs.dreamstime.com/b/gynecologist-doctor-pregnant-woman-hospital-pregnancy-gynecology-medicine-health-care-people-concept-stethoscope-70948901.jpg'} width={300} height={300} />
