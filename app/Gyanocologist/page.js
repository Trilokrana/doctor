  ...
  return (
    <div className={`flex flex-col md:flex-row ${styles.gynaContainer}`}>
      <div className={`border-2 p-6 m-4 rounded-lg w-full md:w-96 hover:bg-gray-100 transition duration-500 ${styles.gynaCard}`}>
        <Image className='rounded-xl' src={'https://www.toplinemd.com/south-miami-obgyn-associates/wp-content/uploads/sites/55/2022/01/8-Things-to-Consider-When-Choosing-a-Gynecologist.jpg'} width={300} height={300} />
      ...
      <div className={`border-2 p-6 m-4 rounded-lg w-full md:w-96 hover:bg-gray-100 transition duration-500 ${styles.gynaCard}`}>
        <Image className='rounded-xl' src={'https://www.drarchanadubey.com/wp-content/uploads/2021/02/PLtTGsTs2t.jpg'} width={300} height={300} />
